...
import 'package:mini_maket/screens/employee/quanLyHoaDon.dart';
import 'package:mini_maket/screens/sanPham.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:mini_maket/screens/login_screen.dart'; // Thay bằng màn hình đăng nhập của bạn
...
class _HomeEmployeeScreenState extends State<HomeEmployeeScreen> with SingleTickerProviderStateMixin {
      ...
      body: Container(
        ...
        child: TabBarView(
          ...
          children: [
            ...
            _buildTabContent(QuanLyHoaDonEmployeeScreen(), "Hóa đơn"),  // Placeholder for "Hóa đơn" tab
          ],
        ),
      ),
